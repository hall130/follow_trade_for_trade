...
from models import Rule, Strategy, SignalAccount, Customer, CustomerTrade
from trade_service import TradeService, get_global_is_demo
import asyncio
        ...
        while reconnect_count < max_reconnect_attempts:
            try:
                ...
                async def on_order(data):
                    try:
                        from db import insert_signal_account_trade, close_signal_account_trade
                        for order in data['data']:
                            ...
                            if order.get('side') in ['buy', 'sell']:
                                ...
                                if is_open_long or is_open_short:
                                    ...
                                    try:
                                        # 检查是否已经处理过这个开仓订单
                                        from db import check_signal_trade_exists
